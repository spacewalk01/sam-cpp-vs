...
The example currently supports only the [ViT-B SAM model checkpoint](https://huggingface.co/facebook/sam-vit-base). You can convert it following the instruction in [sam.cpp](https://github.com/ggerganov/ggml/tree/master/examples/sam) readme but for simplicity, I have converted the model into ggml and uploaded it on cloud.
